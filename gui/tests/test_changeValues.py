...
#     i = startingValue
#     oldValue = 0
#     while i <= int(config['insp_expir_ratio']['max'] + 1) or i == oldValue:
#         window._start_stop_worker._settings.update_spinbox_value('insp_expir_ratio', i)
#         oldValue = i
#         i = i + int(config['insp_expir_ratio']['step'])
...
#     i = startingValue
#     oldValue = 0
#     while i >= int(config['insp_expir_ratio']['min'] - 1) or i == oldValue:
#         window._start_stop_worker._settings.update_spinbox_value('insp_expir_ratio', i)
#         oldValue = i
#         i = i - int(config['insp_expir_ratio']['step'])
